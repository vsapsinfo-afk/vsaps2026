          ...
          {steps.map((step) => {
            ...
            return (
              <div key={step.number} className="flex flex-col items-center relative z-10 w-40 text-center">
                ...
                <span className={`text-[11px] font-extrabold mt-2 uppercase tracking-wide transition-colors duration-300 ${
                  isActive ? 'text-teal-900' : isCompleted ? 'text-teal-700' : 'text-slate-400'
                }`}>
                  {step.label}
                </span>
              ...
              return (
                <div 
                  ...
                  className={`h-2 rounded-full transition-all duration-300 ${
                    isActive ? 'w-6 bg-teal-600' : isCompleted ? 'w-2 bg-teal-500' : 'w-2 bg-slate-200'
                  }`} 
                />
              );
            })}
