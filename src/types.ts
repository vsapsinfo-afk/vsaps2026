...
export interface NotificationTemplate {
  id: string;
  name: string;
  type: 'registration_success' | 'payment_confirmed' | 'abstract_approved' | 'reminder_event' | 'sponsor_registered' | 'sponsor_paid' | 'sponsor_contract' | 'thank_you_survey' | 'speaker_registered';
